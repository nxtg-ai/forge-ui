...
const mockVisionData: VisionData = {
  mission:
    "Build a platform that eliminates developer burnout through intelligent automation",
  goals: [
    {
      id: "1",
      title: "Reduce Cognitive Load",
      description:
        "Implement AI-driven task management that reduces mental overhead by 80%",
      status: "in-progress",
      progress: 65,
      dependencies: [],
    },
    {
      ...
      description:
        "Achieve 3x development velocity through intelligent code generation",
      status: "in-progress",
      progress: 40,
      dependencies: ["1"],
    },
    {
      ...
      description:
        "Maintain 99% code quality through automated testing and review",
      status: "pending",
      progress: 20,
      dependencies: ["2"],
    },
...
export default function App() {
  const [currentView, setCurrentView] = useState<
    "onboarding" | "dashboard" | "discussion"
  >("dashboard");
  ...
  const [automationLevel, setAutomationLevel] =
    useState<AutomationLevel>("balanced");
  ...
  const mockActivities: AgentActivity[] = [
    ...
    },
    {
      agentId: "architect",
      action:
        "Proposed microservices architecture with event-driven communication",
      timestamp: new Date(),
      visibility: "vp",
    },
    {
  ...
  const mockAutomatedActions: AutomatedAction[] = [
    ...
    },
    {
      ...
      description:
        "Added indexes and query optimization for 3x speed improvement",
      impact: "high",
      status: "completed",
      timestamp: new Date(),
      confidence: 94,
  ...
  if (!visionData && currentView === "onboarding") {
    return <VisionCapture onVisionSubmit={handleVisionSubmit} mode="initial" />;
  }
