  ...
  "inline-flex items-center rounded-full font-medium transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-nxtg-purple-900/20 text-nxtg-purple-400 border border-nxtg-purple-800",
        secondary:
          "bg-nxtg-blue-900/20 text-nxtg-blue-400 border border-nxtg-blue-800",
        success:
          "bg-nxtg-success-dark/20 text-nxtg-success-light border border-nxtg-success-DEFAULT",
        warning:
          "bg-nxtg-warning-dark/20 text-nxtg-warning-light border border-nxtg-warning-DEFAULT",
        error:
          "bg-nxtg-error-dark/20 text-nxtg-error-light border border-nxtg-error-DEFAULT",
