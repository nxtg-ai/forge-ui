  ...
  return (
    <div data-testid="yolo-panel" className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              {currentLevel.icon}
              <span
                className={`text-sm font-medium text-${currentLevel.color}-400`}
              >
                {currentLevel.label}
              </span>
            </div>
      ...
      {enabled && showDetails && recentActions.length > 0 && (
        ...
        >
          <h3
            data-testid="yolo-actions-title"
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-2 text-xs">
                          <div
                            className={`px-2 py-1 rounded-lg ${getStatusColor(action.status)}`}
                          >
                            {action.status}
                          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div
                      className={`inline-flex px-3 py-1 rounded-lg ${getStatusColor(selectedAction.status)}`}
                    >
                ...
                {selectedAction.status === "failed" && (
                  <div className="p-4 rounded-xl bg-red-900/20 border border-red-500/30">
                    ...
                    <p className="text-sm text-gray-300">
                      The system will analyze the failure and adjust future
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    data-testid="yolo-view-logs-btn"
